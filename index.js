...
/******/ 		return __webpack_require__.p + "" + ({"sub":"sub"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
console.log('start');
setTimeout(function () {
  __webpack_require__.e(/*! import() | sub */ "sub").then(__webpack_require__.bind(null, /*! ./sub.js */ "./src/sub.js")).then(function (_ref) {
    var Sub = _ref.Sub;
